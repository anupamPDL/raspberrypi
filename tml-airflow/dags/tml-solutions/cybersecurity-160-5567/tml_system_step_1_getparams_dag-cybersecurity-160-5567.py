...
default_args = {
 ...
 'solutionname': 'cybersecurity-160-5567',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'Project #2', # <<< *** Provide a descriptive title for your solution
...
@dag(dag_id="tml_system_step_1_getparams_dag_cybersecurity-160-5567", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cybersecurity-160-5567"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass

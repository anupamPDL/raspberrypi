...
step3 = importlib.import_module("tml-solutions.project#2-teammatrix-5567.tml_read_gRPC_step_3_kafka_producetotopic_dag-project#2-teammatrix-5567")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-project#2-teammatrix-5567",

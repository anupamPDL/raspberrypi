...
default_args = {
  ...
  'dashboardhtml': 'index.html', # <<< *** name of your dashboard html file  try: iot-failure-seneca.html
...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_project#2-teammatrix-5567", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_project#2-teammatrix-5567"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()

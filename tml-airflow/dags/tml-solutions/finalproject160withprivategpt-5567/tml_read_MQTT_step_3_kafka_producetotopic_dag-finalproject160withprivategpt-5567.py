...
default_args = {
  ...
  'mqtt_broker' : 'b526253c5560459da5337e561c142369.s1.eu.hivemq.cloud', #<<<< Professor's cluster
  #'mqtt_broker' : '557a86c36cb94b68b1b375d8a0ba2b92.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_finalproject160withprivategpt-5567", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_finalproject160withprivategpt-5567"], schedule=None,catchup=False)
